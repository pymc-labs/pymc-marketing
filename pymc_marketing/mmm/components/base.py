...
class Transformation:
    ...
    Parameters
    ----------
    priors : dict[str, XPrior | float | XTensorVariable | VariableFactory | list  | numpy array], optional
    ...
    prefix: str
    default_priors: dict[str, XPrior]
    function: Any
    lookup_name: str
    ...
    def update_priors(self, priors: dict[str, XPrior | Prior]) -> None:
        ...
        .. code-block:: python
            ...
            from pymc.marketing.mmm.dims import XPrior
