...
from tests.conftest import create_mock_fit, mock_sample, test_sbg_data
...
class TestShiftedBetaGeoModel:
    ...
    # TODO: distribution_customer_churn_time may be renamed
    ...
    def test_posterior_distributions(self, fit_type):
        ...
        data = model.data
        customer_churn_time = model.distribution_customer_churn_time(
